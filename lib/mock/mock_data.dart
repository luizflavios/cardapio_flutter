...
List<Meal> MOCK_MEALS = [
  ...
  Meal(
    id: 5,
    categories: [MOCK_CATEGORIES[2], MOCK_CATEGORIES[5], MOCK_CATEGORIES[9]],
  ...
  Meal(
    id: 6,
    categories: [MOCK_CATEGORIES[0], MOCK_CATEGORIES[7]],
